---
title: Interview by Rafael Zen at Massy Art Gallery
slug: reviews/rafael-zen
published: true
---
import CldImage from '../../components/CldImage.astro'
import Contact from "../../components/forms/Contact.astro";
import ScrollToTop from "../../components/content/ScrollToTop.astro";

<small>Originally published on August 3, 2022</small>
# Interview by Rafael Zen at Massy Art Gallery
This [Interview](https://massyarts.com/massy-interviews-yasaman-moussavi/) is originally published on the Massy Art gallery website.

To celebrate Inter/me/diary, Rafael Zen interviews Moussavi for Massy Arts, addressing the artist’s investigation on the traditional central courtyard of Persian domestic architecture, and her interest on paper as an artistic media.

<CldImage
  id='yasi-portfolio/shedcrzldbd0qwd4v5qu'
  width={400}
  height={400}
  mode='fill'
  class='object-cover rounded-lg mx-auto'
  alt='Massy Exhibition Cover'
/>
...
<CldImage
  id='yasi-portfolio/uggo8g6siiketbbrlgbc'
  width={400}
  height={400}
  mode='fill'
  class='object-cover rounded-lg mx-auto'
  alt='Capturing the sahadows'
/>
...
<CldImage
  id='yasi-portfolio/ivs6v5qaainav5yt763s'
  width={800}
  height={400}
  mode='fill'
  class='object-cover rounded-lg mx-auto mb-4 mx-0'
  alt='Shiraz?'
/>
<div class="grid grid-cols-2 gap-4 mb-2">
  <CldImage
    id='yasi-portfolio/eb5vqp2vlvaxxoazuwka'
    width={400}
    height={500}
    mode='fill'
    class='object-cover rounded-lg mx-auto mb-0 h-full my-0'
    alt='Shiraz?'
  />
  <CldImage
    id='yasi-portfolio/g0fzvvh0vour7x2tf4xs'
    width={400}
    height={500}
    mode='fill'
    class='object-cover rounded-lg mx-auto mb-0  h-full my-0'
...
<small>This image needs caption</small>
...
<CldImage
  id='yasi-portfolio/vbk67ly5oj9c6mmsefrv'
  width={800}
  height={500}
  mode='fill'
  class='object-cover rounded-lg mx-auto mb-0'
  alt='Shiraz?'
/>
<small>A detail of a family letter</small>
